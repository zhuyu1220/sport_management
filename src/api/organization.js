...
*/
export const getOrgByParentId = (params) => {
...
*/
export const getStudentByOrgId = (data) => {
...
/*
  ...
  @return 
*/
export const getQueryOrg = (params) => {
  return request({method:'get',url:"/system/org/queryOrg",params})
}
//同步学生年级信息
export const syncStudentGradeInfo = () => {
