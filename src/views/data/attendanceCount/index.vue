  ...
  <div class="wrapper">
    ...
    >
      ...
      <el-table-column prop="name" label="姓名" width="width">
          ...
          <el-table-column prop="picUrl" label="照片" width="width">
      </el-table-column>
       <el-table-column prop="place" label="上报地点" width="width">
      </el-table-column>
...
import {  getUserAttByPage } from "@/api/index.js";
...
export default {
  ...
  methods: {
    ...
    async reqQueryByPages() {
      this.loading = true;
      try {
        const res = await getUserAttByPage(this.queryParams);
