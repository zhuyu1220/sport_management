  ...
  <div class="wrapper">
    ...
    >
      ...
      <el-table-column prop="name" label="姓名" width="width">
          ...
          <el-table-column prop="mile" label="运动里程" width="width">
      </el-table-column>
       <el-table-column prop="duration" label="运动时长" width="width">
      </el-table-column>
    </el-table>
...
import {  getUserExerciseByPage } from "@/api/index.js";
...
export default {
  ...
  methods: {
    ...
    async reqQueryByPages() {
      this.loading = true;
      try {
        const res = await getUserExerciseByPage(this.queryParams);
