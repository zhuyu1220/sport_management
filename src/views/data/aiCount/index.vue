<template>
  <div class="wrapper">
    ...
    >
      ...
      <el-table-column type="index" prop="className" label="班级名称"  width="100px" >
      </el-table-column>
      ...
      <el-table-column prop="fuwo" label="俯卧撑" width="width">
      </el-table-column>
         <el-table-column prop="qianqu" label="坐立前屈" width="width">
      </el-table-column>
         <el-table-column prop="tiaosheng" label="跳绳" width="width">
      </el-table-column>
         <el-table-column prop="tiaoyuan" label="跳远" width="width">
      </el-table-column>
         <el-table-column prop="yangwo" label="仰卧起坐" width="width">
      </el-table-column>
...
import {  getAiExerciseByPage } from "@/api/index.js";
...
export default {
  ...
  methods: {
    ...
    handleResetSearch() {
      ...
      this.queryParams.classCode = "";
      this.queryParams.sday = "";
      this.queryParams.eday = "";
    ...
    async reqQueryByPages() {
      this.loading = true;
      try {
        const res = await getAiExerciseByPage(this.queryParams);
